          ...
          >
            <div className="inline-block w-full max-w-md p-4 my-8 text-left align-middle transition-all transform bg-white shadow-xl overflow-show dark:bg-slate-700 rounded-2xl">
              ...
              <div className="mt-4 space-x-2 text-right">
                ...
                <button
                  type="button"
                  className="inline-flex justify-center px-8 py-4 text-sm font-medium text-white border border-transparent rounded-xl bg-sky-500 active:bg-sky-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-sky-300"
                  onMouseUp={onPlay}
                  onTouchEnd={onPlay}
                >
                  Play
